...
export function AppSidebar({ activeRoute = 'campaigns', onNavigate, userType = 'dealer', onToggleUserType }: AppSidebarProps) {
        ...
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[11px] py-1 relative size-full">
            <div 
              ...
              title={`Switch to ${userType === 'dealer' ? 'OEM' : 'Dealer'} View`}
            >
              {userType === 'dealer' ? (
                ...
                <div className="relative shrink-0 size-[40px]" data-name="Brand Logo/Volks">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
                    <g id="Brand Logo/Volks">
                      <rect fill="white" height="40" rx="4" width="40" />
                      <path d={VOLKS_LOGO_PATH} fill="#1F1D25" id="Vector" />
                    </g>
                  </svg>
                </div>
              )}
