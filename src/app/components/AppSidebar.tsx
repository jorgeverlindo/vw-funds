...
function ClientLogoImg({ src, alt, scale = 1, noPadding = false, fit = 'auto' }: { src: string; alt: string; scale?: number; noPadding?: boolean; fit?: 'auto' | 'contain' | 'cover' }) {
  // [FV] white square with 5px horizontal padding so the mark is centered and never touches the edge.
  // `scale` lets specific marks (e.g. VW OEM, whose PNG has internal whitespace) be enlarged.
  // `fit` overrides the objectFit: 'contain' forces wide/landscape logos to never crop.
    ...
    >
      <div className="flex flex-col items-center justify-end size-full">
        <div className="content-stretch flex flex-col gap-2 items-center justify-end pb-[3px] pt-[7px] px-4 relative w-full">
          ...
          <div className="relative z-10 size-6" style={{ color: iconColor }}>
            {icon}
          </div>
...
export function AppSidebar({
  ...
  return (
    <div className="fixed left-0 top-0 bottom-0 w-[72px] flex flex-col items-center z-50 isolate" style={{ backgroundColor: 'var(--rail-bg)' }}>
        ...
        <div className="flex flex-col items-center size-full">
          <div className="content-stretch flex flex-col gap-3 items-center pb-0 pt-4 px-[3px] relative size-full">
            ...
            <NavItem
              ...
              iconColor={getIconColor('projects')}
            ...
            <NavItem
              ...
              iconColor={getIconColor('campaigns')}
            ...
            <NavItem
              ...
              iconColor={getIconColor('inventory')}
            ...
            <NavItem
              ...
              iconColor={getIconColor('insights')}
            ...
            <NavItem
              ...
              iconColor={getIconColor('ai-tools')}
