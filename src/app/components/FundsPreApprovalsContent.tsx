...
export const MOCK_DATA: PreApproval[] = [
  ...
  // ── Volkswagen Any Town (408258) pre-approvals ────────────────────────────
  {
    ...
    mediaType: 'Display / Internet Banners',
    details: 'Spring Digital Display — Q2 2026',
    lastUpdated: new Date(2026, 2, 14),
    submittedAt: new Date(2026, 2, 12),
    initiativeType: 'Pre-Approval',
    claimsCount: 0,
    contactEmail: 'mallory@vwanytown.com',
    description: 'Spring display campaign across Google Display Network and programmatic channels.',
    documents: [],
  },
  {
    id: 'MFA386596',
    ...
    details: 'Facebook & Instagram — Feb 2026',
    lastUpdated: new Date(2026, 1, 19),
    submittedAt: new Date(2026, 1, 16),
    initiativeType: 'Pre-Approval',
    claimsCount: 1,
    contactEmail: 'mallory@vwanytown.com',
    description: 'Social media campaign targeting in-market shoppers within 25-mile radius.',
    documents: [],
  },
  {
    id: 'MFA386597',
    ...
    submittedBy: { name: 'Mallory Manning', avatarUrl: AVATARS[5] },
    mediaType: 'Search SEM',
    details: 'Google SEM — Jan 2026',
    lastUpdated: new Date(2026, 0, 9),
    submittedAt: new Date(2026, 0, 4),
    initiativeType: 'Pre-Approval',
    claimsCount: 1,
    contactEmail: 'mallory@vwanytown.com',
    description: 'Paid search campaign on Google Ads covering Tiguan, Jetta and ID.4 keywords.',
    documents: [],
  },
  {
    id: 'MFA386598',
    ...
    submittedBy: { name: 'Mallory Manning', avatarUrl: AVATARS[5] },
    mediaType: 'Video / OTT',
    details: 'OTT Video — Holiday 2025',
    lastUpdated: new Date(2025, 11, 4),
    submittedAt: new Date(2025, 10, 27),
    initiativeType: 'Pre-Approval',
    claimsCount: 0,
    contactEmail: 'mallory@vwanytown.com',
    description: 'Holiday OTT/CTV video campaign on Hulu and Peacock.',
    documents: [],
  },
  {
    id: 'MFA386599',
    ...
    submittedBy: { name: 'Mallory Manning', avatarUrl: AVATARS[5] },
    mediaType: 'Search SEM',
    details: 'Google SEM — Nov 2025',
    lastUpdated: new Date(2025, 10, 1),
    submittedAt: new Date(2025, 10, 1),
    initiativeType: 'Pre-Approval',
    claimsCount: 1,
    contactEmail: 'mallory@vwanytown.com',
    description: 'Revision requested due to image quality guidelines not met on ad creative.',
    documents: [],
  },
  {
    id: 'MFA386601',
    ...
    submittedBy: { name: 'Mallory Manning', avatarUrl: AVATARS[5] },
    mediaType: 'Display / Internet Banners',
    details: 'Fall Display Campaign — Sep 2025',
    lastUpdated: new Date(2025, 8, 17),
    submittedAt: new Date(2025, 8, 14),
    initiativeType: 'Pre-Approval',
    claimsCount: 1,
    contactEmail: 'mallory@vwanytown.com',
    description: 'Display banners for fall inventory clearance across IAB standard placements.',
    documents: [],
  },
  {
    id: 'MFA386600',
