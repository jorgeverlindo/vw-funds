// ─── FormattingToolbar ────────────────────────────────────────────────────────
// Renders the B / I / U / S (strikethrough) toolbar for the comment composer.
...
function ToolbarButton({ title, command, children, onFormat }: ToolbarButtonProps) {
  return (
    <button
      type="button"
      title={title}
...
export function FormattingToolbar({ onFormat, className = "" }: FormattingToolbarProps) {
  return (
    ...
    >
      {/* Bold */}
      <ToolbarButton title="Bold" command="bold" onFormat={onFormat}>
      ...
      {/* Italic */}
      <ToolbarButton title="Italic" command="italic" onFormat={onFormat}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Underline */}
      <ToolbarButton title="Underline" command="underline" onFormat={onFormat}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Strikethrough */}
      <ToolbarButton title="Strikethrough" command="strikeThrough" onFormat={onFormat}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
