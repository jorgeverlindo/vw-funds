...
export const offerLibrary = [
  ...
  },
  {
    ...
    model: "X5 M",
    trim: "Competition",
    image: "/cars/X5 - Competition2.png",
    stock: 3,
    offerType: "APR",
    tags: ["National"],
    pvi: 87,
...
export function getProjectLogoUrl(projectId: string): string {
  return PROJECT_OVERRIDES[projectId]?.logoUrl ?? "/logos/Honda-Logo.png";
}
...
export const brandKits: BrandKit[] = [
  {
    ...
    logos: [
      { id: "primary-square-positive",  label: "Primary Square",     sublabel: "Positive",   image: "/brand-kits/honda/primary-square-positive.png" },
      { id: "primary-square-positive2", label: "Primary Square",     sublabel: "Positive 2", image: "/brand-kits/honda/primary-square-positive2.png" },
      { id: "primary-square-negative",  label: "Primary Square",     sublabel: "Negative",   image: "/brand-kits/honda/primary-square-negative.png" },
      { id: "event-square-positive",    label: "Event Square",       sublabel: "Positive",   image: "/brand-kits/honda/event-square-positive.png" },
      { id: "event-square-negative",    label: "Event Square",       sublabel: "Negative",   image: "/brand-kits/honda/event-square-negative.png" },
      { id: "event-horizontal-positive",  label: "Event Horizontal", sublabel: "Positive",   image: "/brand-kits/honda/event-horizontal-positive.png" },
      { id: "event-horizontal-positive2", label: "Event Horizontal", sublabel: "Positive 2", image: "/brand-kits/honda/event-horizontal-positive2.png" },
      { id: "event-horizontal-positive3", label: "Event Horizontal", sublabel: "Positive 3", image: "/brand-kits/honda/event-horizontal-positive3.png" },
      { id: "event-horizontal-positive4", label: "Event Horizontal", sublabel: "Positive 4", image: "/brand-kits/honda/event-horizontal-positive4.png" },
      { id: "event-horizontal-positive5", label: "Event Horizontal", sublabel: "Positive 5", image: "/brand-kits/honda/event-horizontal-positive5.png" },
      { id: "event-horizontal-negative",  label: "Event Horizontal", sublabel: "Negative",   image: "/brand-kits/honda/event-horizontal-negative.png" },
      { id: "event-horizontal-negative2", label: "Event Horizontal", sublabel: "Negative 2", image: "/brand-kits/honda/event-horizontal-negative2.png" },
    ],
  },
  {
    id: "bmw",
    ...
    logos: [
      { id: "primary-square-positive", label: "Primary Square", sublabel: "Positive", image: "/brand-kits/bmw/primary-square-positive.png" },
      { id: "primary-square-negative", label: "Primary Square", sublabel: "Negative", image: "/brand-kits/bmw/primary-square-negative.png" },
    ],
  },
  {
    id: "spiriva",
    ...
    logos: [
      { id: "primary-logo", label: "Primary Logo", sublabel: "Main", image: "/logos/Spiriva.png" },
    ],
  },
  {
    id: "mercedes",
    ...
    logos: [
      { id: "primary-square-positive",   label: "Primary Square",    sublabel: "Positive", image: "/brand-kits/mercedes/primary-square-positive.png" },
      { id: "primary-square-negative",   label: "Primary Square",    sublabel: "Negative", image: "/brand-kits/mercedes/primary-square-negative.png" },
      { id: "event-square-negative",     label: "Event Square",      sublabel: "Negative", image: "/brand-kits/mercedes/event-square-negative.png" },
      { id: "event-horizontal-negative", label: "Event Horizontal",  sublabel: "Negative", image: "/brand-kits/mercedes/event-horizontal-negative.png" },
    ],
  },
];
...
export const backgroundCollections = [
  {
    ...
    color: "#c8a86b",
    thumbnail: "/backgrounds/Dirt-Road-HO_251027_1_Display_300x250 1.png",
    images: {
      "website-2000x500": "/backgrounds/Dirt-Road-HO_251027_1_Website_2000x500 1.png",
      "display-970x250":  "/backgrounds/Dirt-Road-HO_251027_1_Display_970x250 1.png",
      "display-300x250":  "/backgrounds/Dirt-Road-HO_251027_1_Display_300x250 1.png",
      "social-1080x1080": "/backgrounds/Dirt-Road-HO_251027_1_Social_1080x1080 1.png",
      "website-600x450":  "/backgrounds/Dirt-Road-HO_251027_1_Website_600x540 1.png",
      "website-600x1067": "/backgrounds/Dirt-Road-HO_251027_1_Website_600x1067 1.png",
    },
  },
  {
    id: "gold-flare",
    ...
    folder: "Background Collections",
    color: "#e8a020",
    thumbnail: "/backgrounds/Gold-Flare-HO_251027_3_Display_300x250 1.png",
    images: {
      "website-2000x500": "/backgrounds/Gold-Flare-HO_251027_3_Website_2000x500 1.png",
      "display-970x250":  "/backgrounds/Gold-Flare-HO_251027_3_Display_970x250 1.png",
      "display-300x250":  "/backgrounds/Gold-Flare-HO_251027_3_Display_300x250 1.png",
      "social-1080x1080": "/backgrounds/Gold-Flare-HO_251027_3_Social_1080x1080 1.png",
      "website-600x450":  "/backgrounds/Gold-Flare-HO_251027_3_Website_600x540 1.png",
      "website-600x1067": "/backgrounds/Gold-Flare-HO_251027_3_Website_600x1067 1.png",
    },
  },
  {
    id: "purple-city",
    ...
    folder: "Background Collections",
    color: "#7060a0",
    thumbnail: "/backgrounds/Purple-City-HO_251229_D_Keeler_Display_300x250 1.png",
    images: {
      "website-2000x500": "/backgrounds/Purple-City-HO_251229_D_Keeler_Website_2000x500 1.png",
      "display-970x250":  "/backgrounds/Purple-City-HO_251229_D_Keeler_Display_970x250 1.png",
      "display-300x250":  "/backgrounds/Purple-City-HO_251229_D_Keeler_Display_300x250 1.png",
      "social-1080x1080": "/backgrounds/Purple-City-HO_251229_D_Keeler_Social_1080x1080 1.png",
      "website-600x450":  "/backgrounds/Purple-City-HO_251229_D_Keeler_Website_600x450 1.png",
      "website-600x1067": "/backgrounds/Purple-City-HO_251229_D_Keeler_Website_600x1067 1.png",
    },
  },
  {
    id: "snow-house",
    ...
    folder: "Background Collections",
    color: "#b8cce0",
    thumbnail: "/backgrounds/Snow-House-HO_251120_2_Display_300x250 1.png",
    images: {
      "website-2000x500": "/backgrounds/Snow-House-HO_251120_3_Website_2000x500 1.png",
      "display-970x250":  "/backgrounds/Snow-House-HO_251120_2_Display_970x250 1.png",
      "display-300x250":  "/backgrounds/Snow-House-HO_251120_2_Display_300x250 1.png",
      "social-1080x1080": "/backgrounds/Snow-House-HO_251120_2_Social_1080x1080 1.png",
      "website-600x450":  "/backgrounds/Snow-House-HO_251120_2_Website_600x540 1.png",
      "website-600x1067": "/backgrounds/Snow-House-HO_251120_2_Website_600x1067 1.png",
    },
  },
  ...lifestyleImages,
